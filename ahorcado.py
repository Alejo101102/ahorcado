...
PISTAS = {
    ...
    "computadora": "Máquina electrónica 🖥️",
    "teclado": "Dispositivo de entrada ⌨️",
    "monitor": "Pantalla del PC 🖥️",
    ...
    "clase": "Plantilla de objetos en OOP 🏗️",
    ...
    "base": "Fundamento o cimientos 🏛️",
    "pantalla": "Superficie de visualización 📺",
    "ratón": "Dispositivo señalador 🖱️",
    "impresora": "Máquina que imprime 🖨️",
    "servidor": "Computadora que provee servicios 🗄️",
    ...
    "aventura": "Experiencia emocionante 🗺️",
    "musica": "Arte de los sonidos 🎵",
    "pelicula": "Obra cinematográfica 🎬",
    "viaje": "Desplazamiento a otro lugar ✈️",
